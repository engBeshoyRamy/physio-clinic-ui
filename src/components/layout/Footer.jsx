            ...
            <div className="flex items-center gap-3">
              {socials.map(s => (
                <a
                  ...
                  aria-label={s.label}
                  className={`w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200 ${s.hover}`}
                >
                  {s.icon}
                </a>
              ))}
              ...
              {footerLinks.map(link => (
                <li key={link.label}>
                  <button
                    ...
                    className="text-gray-400 hover:text-white text-sm transition-colors duration-200 font-body text-left"
                  >
                    {link.label}
                  </button>
                </li>
